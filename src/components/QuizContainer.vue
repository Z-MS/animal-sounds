<script setup>
    ...
    onBeforeMount(() => {
        async function enableInlineSVG() {
            isInlineSVGEnabled = await configCatClient.getValueAsync("inline_svg_enabled", false);
        }
        enableInlineSVG();
    })
    ...
    <div class="question">
        ...
        <div id="sound__button__container">
            <button id="sound__icon__button" class="btn btn-info" @click="playSound">
                <img v-if="isInlineSVGEnabled" id="sound__icon" src="/loudspeaker.svg" width="50"/>
                 <svg v-else id="loudspeaker_icon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="16" height="16" viewBox="0 0 16 16">
